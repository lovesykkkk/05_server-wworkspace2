...
<body>
    ...
    <p>
        ...
        우리가 기존에 a태그로 요청 및 form submit 요청 방식은 "동기식 요청" 이였음 => 응답페이지가 돌아와야만 볼 수 있음(페이지 깜빡거림) <br><br>
        ...
        * 동기식 / 비동기식 <br>
        ...
        <ul>
            ...
            <li>요청을 보냈다고 해서 다른페이지로 넘어가지 않음 (현재 페이지 그대로 유지)</li>
        ...
        * 비동기식의 단점 <br>
        ...
        - 에러 발생시 디버깅 어려움 <br>
        - 요청 처리 후에 돌아온 응답데이터를 가지고 현재페이지에 새로운 요소를 만들어서 뿌려줘야 될꺼임 =? dom요소들을 새로이 만들어내는 구문을 잘 익혀둬야됨 
        <br><br>

        * AJAX 구현 방식 => 순수 JavaScript 방식 (어려움, 브라우져 마다 다르게 짜야함) / jQuery 방식(코드가 간결하고 사용하기 쉬움)
    </p>
